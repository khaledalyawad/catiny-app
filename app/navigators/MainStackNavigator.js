...
import {IMContactUsScreen, IMEditProfileScreen, IMProfileSettingsScreen, IMUserSettingsScreen} from '../Core/profile';
import {IMAllFriendsScreen} from '../Core/socialgraph/friendships';
import {IMNotificationScreen} from '../Core/notifications';
import {DetailPostScreen, FeedSearchScreen, ProfileScreen} from '../screens';
...
const MainStackNavigator = () =>
{
  return (
    <MainStack.Navigator
      ...
      <MainStack.Screen options={{headerShown: false}} name='FeedSearch' component={FeedSearchScreen} />
      ...
      <MainStack.Screen name='ProfileSettings' component={IMProfileSettingsScreen} />
      ...
      <MainStack.Screen name='MainProfilePostDetails' component={DetailPostScreen} />
    </MainStack.Navigator>
  );
};
