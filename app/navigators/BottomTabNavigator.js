  ...
  return (
    <BottomTab.Navigator
      ...
      tabBar={({state, route, navigation}) => (
        <TabBarBuilder tabIcons={SocialNetworkConfig.tabIcons} appStyles={AppStyles} route={route} state={state} navigation={navigation} />
      )}
      ...
      <BottomTab.Screen name='Friends' component={InnerFriendsSearchNavigator} />
