...
import { View, TouchableOpacity, Platform, ScrollView, Dimensions } from 'react-native';
...
export default class TNMediaViewerModal extends React.Component {
  ...
  onImageLoad = (evt, uri) => {
    ...
    const ImageHeight = evt.nativeEvent?.source?.height || evt.nativeEvent?.height;
  ...
  renderCloseButton() {
    return (
      <TouchableOpacity style={styles.closeButton} onPress={this.props.onClosed}>
              ...
              <View
                ...
                {uri && (
                  <Image
                    ...
                    style={[styles.deck, { height: heights[uri] || heights['default'] }]}
