...
const WelcomeScreen = (props) =>
{
  ...
  const appStyles = props?.appStyles ? props?.appStyles : props.route?.params?.appStyles;
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.logo}>
        <Image style={styles.logoImage} source={props.delayedMode ? appStyles.iconSet.delayedLogo : appStyles.iconSet.logo} />
      </View>
      <Text style={styles.title}>{title ? title : appConfig.onboardingConfig.welcomeTitle}</Text>
      <Text style={styles.caption}>{caption ? caption : appConfig.onboardingConfig.welcomeCaption}</Text>
      <Button
