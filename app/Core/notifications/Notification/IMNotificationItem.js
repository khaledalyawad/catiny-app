...
const IMNotificationItem = memo((props) => {
  ...
  return (
    <TouchableOpacity
      ...
      style={[styles.notificationItemBackground, item.seen ? styles.seenNotificationBackground : styles.unseenNotificationBackground]}>
      <View style={styles.notificationItemContainer}>
        ...
        <View style={styles.notificationLabelContainer}>
          ...
          <Text style={[styles.description, styles.moment]}>{timeFormat(item.createdAt)}</Text>
        </View>
      </View>
    </TouchableOpacity>
  );
