    ...
    <View style={styles.audioMediaThreadItemContainer}>
      ...
      <View style={styles.audioMeterContainer}>
        <Slider
          ...
          onSlidingComplete={(value) => onSeekSliderSlidingComplete(value, soundDuration)}
      ...
      <View style={styles.audioTimerContainer}>
        {isLoading ? (
          ...
          <Text style={styles.audioTimerCount}>
            {soundRef.current !== null ? getPlaybackTimestamp(soundPosition, soundDuration) : getMMSSFromMillis(item.duration)}
          </Text>
        )}
      </View>
    </View>
