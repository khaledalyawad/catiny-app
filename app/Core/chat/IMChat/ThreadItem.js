      ...
      return (
        <View style={isMine ? styles.inReplyToItemContainerView : styles.inReplyToTheirItemContainerView}>
          ...
          <View style={styles.inReplyToItemBubbleView}>
            <Text style={styles.inReplyToItemBubbleText}>{item.inReplyToItem.content.slice(0, 50)}</Text>
          </View>
        </View>
      );
    }
      ...
      <View>
        ...
        {outBound && (
          <>
              ...
              {!item.url && (
                <View style={[styles.myMessageBubbleContainerView]}>
                  ...
                  <View style={[styles.itemContent, styles.sendItemContent]}>
                    <IMRichTextView defaultTextStyle={styles.sendTextMessage}>{item.content}</IMRichTextView>
                    {renderTextBoederImg()}
                  </View>
                </View>
              )}
            ...
            {isRecentItem && (
              <View style={styles.sendItemContainer}>
                <FacePile appStyles={appStyles} numFaces={4} faces={readFacePile} />
              </View>
            )}
          </>
        )}
            ...
            {!item.url && (
              <View style={styles.theirMessageBubbleContainerView}>
                ...
                <View style={[styles.itemContent, styles.receiveItemContent]}>
                  <IMRichTextView defaultTextStyle={styles.receiveTextMessage}>{item.content}</IMRichTextView>
                  {renderTextBoederImg()}
                </View>
              </View>
            )}
