...
function IMFormComponent(props) {
    ...
    return (
      <TouchableOpacity
        ...
        <ActionSheet
          ...
          onPress={(selectedIndex) => onActionSheetValueSelected(selectField, selectedIndex)}
        />
      </TouchableOpacity>
    );
  };
  ...
  return <View style={styles.container}>{form.sections.map((section) => renderSection(section))}</View>;
}
