...
export default class FriendshipManager
{
  ...
  {
    this.inboundFriendshipsUnsubscribe = friendship.subscribeToInboundFriendships(userID, this.onInboundFriendshipsUpdate);
    this.outboundFriendshipsUnsubscribe = friendship.subscribeToOutboundFriendships(userID, this.onOutboundFriendshipsUpdate);
  };
  ...
  hydrateFriendships()
  {
    ...
    if (inboundFriendships && outboundFriendships)
    {
      ...
      if (this.callback)
      {
        this.callback(friendshipsFromFriends, friendshipsFromInbound, friendshipsFromOutbound);
      }
    }
  }
}
