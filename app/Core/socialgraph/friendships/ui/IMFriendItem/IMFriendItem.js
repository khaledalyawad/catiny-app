...
const IMFriendItem = memo((props) =>
{
  ...
  return (
    <TouchableOpacity activeOpacity={0.9} onPress={() => onFriendItemPress && onFriendItemPress(item)} style={styles.friendItemContainer}>
      <View style={styles.chatIconContainer}>
        <IMConversationIconView style={styles.photo} imageStyle={styles.photo} participants={[user]} appStyles={appStyles} />
